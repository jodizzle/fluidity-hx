...
class CustomRenderer
{
    ...
    public var renderPreFunc:LimeObject->Void = function(o){};
    public var renderPostFunc:LimeObject->Void = function(o){};

    public var postProcessInitFunc:GLProgram->Void = function(f){};

    public var postProcessRenderPreFunc:LimeObject->Void = function(o){};
    public var postProcessRenderPostFunc:LimeObject->Void = function(o){};
